...
public class Task01 {
    ...
    private static int findLCM(int firstNumber, int secondNumber) {
        return firstNumber * secondNumber / (Helper.findGCD(firstNumber, secondNumber));
    }

    /**
     * See {@link Helper#findGCD(int, int)} and {@link #findLCM(int, int)} docs for more details
     */
    ...
    public static void run(int firstNumber, int secondNumber) {
        ...
        System.out.println("The greatest common divisor: " + Helper.findGCD(firstNumber, secondNumber));
